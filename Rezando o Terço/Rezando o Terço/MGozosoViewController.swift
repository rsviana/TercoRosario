//
//  MGozosoViewController.swift
//  Rezando o Terço
//
//  Created by Rodrigo Viana on 25/03/20.
//  Copyright © 2020 Rodrigo Viana. All rights reserved.
//

import UIKit

class MGozosoViewController: UIViewController {
    
    
    // Orações
    func alertaAgradecimento(){
        let alerta = UIAlertController(title: "Agradecimento", message: "Infinitas graças vos damos, Soberana Rainha, pelos benefícios que todos os dias recebemos de vossas mãos liberais (divinais/maternais).Dignai-vos, agora e para sempre, tomar-nos debaixo de vosso poderoso amparo e para mais vos alegrar (obrigar/agradecer) vos saudamos com uma Salve Rainha:", preferredStyle: .alert)
                 let amem = UIAlertAction(title: "Amém", style: .default) { (UIAlertAction) in
                    let rezaUma = Oracoes()
                    self.salveRainha()
                    
                 }
                     present(alerta, animated: true, completion: nil)
                     alerta.addAction(amem)
    }
    ...
    //Oferecimentos
    func OferecimentoGozosos(){
        tituloOracao.text = "Oferecimento"
        lbOracoes.text = "Divino Jesus, eu vos ofereço este terço (Rosário) que vou rezar, contemplando os mistérios de nossa Redenção. Concedei-me, pela intercessão de Maria, vossa Mãe Santíssima, a quem me dirijo, as graças necessárias para bem rezá-lo para ganhar as indulgências desta santa devoção. (Pode-se acrescentar o que segue, e também intenções particulares. "
        lbAmem.text = ""
    }
    
    // Funções
    
    // Função para validar o mistério de cada passada
    func validaMisterio(){
        if (controlOracaoTerco.currentPage == 0) && (lblMisterios.text == "Mistérios Gozosos") {
            PrimeiroMisterioGoz()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 0) && (lblMisterios.text == "Mistérios Dolorosos"){
            PrimeiroMisterioDol()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 0) && (lblMisterios.text == "Mistérios Gloriosos"){
            PrimeiroMisterioGlo()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 0) && (lblMisterios.text == "Mistérios Luminosos"){
            PrimeiroMisterioLum()
            controlOracaoFull.currentPage += 1
        }
        else if (controlOracaoTerco.currentPage == 1) && (lblMisterios.text == "Mistérios Gozosos") {
            SegundoMisterioGoz()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 1) && (lblMisterios.text == "Mistérios Dolorosos"){
            SegundoMisterioDol()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 1) && (lblMisterios.text == "Mistérios Gloriosos"){
            SegundoMisterioGlo()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 1) && (lblMisterios.text == "Mistérios Luminosos"){
            SegundoMisterioLum()
            controlOracaoFull.currentPage += 1
        }
        else if (controlOracaoTerco.currentPage == 2) && (lblMisterios.text == "Mistérios Gozosos"){
            TerceiroMisterioGoz()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 2) && (lblMisterios.text == "Mistérios Dolorosos"){
            TerceiroMisterioDol()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 2) && (lblMisterios.text == "Mistérios Gloriosos"){
            TerceiroMisterioGlo()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 2) && (lblMisterios.text == "Mistérios Luminosos"){
            TerceiroMisterioLum()
            controlOracaoFull.currentPage += 1
        }
        else if (controlOracaoTerco.currentPage == 3) && (lblMisterios.text == "Mistérios Gozosos"){
            QuartoMisterioGoz()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 3) && (lblMisterios.text == "Mistérios Dolorosos"){
            QuartoMisterioDol()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 3) && (lblMisterios.text == "Mistérios Gloriosos"){
            QuartoMisterioGlo()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 3) && (lblMisterios.text == "Mistérios Luminosos"){
            QuartoMisterioLum()
            controlOracaoFull.currentPage += 1
        }
        else if (controlOracaoTerco.currentPage == 4) && (lblMisterios.text == "Mistérios Gozosos"){
            QuintoMisterioGoz()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 4) && (lblMisterios.text == "Mistérios Dolorosos"){
            QuintoMisterioDol()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 4) && (lblMisterios.text == "Mistérios Gloriosos"){
            QuartoMisterioGlo()
            controlOracaoFull.currentPage += 1
        }else if (controlOracaoTerco.currentPage == 4) && (lblMisterios.text == "Mistérios Luminosos"){
            QuintoMisterioLum()
            controlOracaoFull.currentPage += 1
        }
    }
    ...
    // --------- Acoes
    // - Avanco da primeira parte do terço...
    func nextFirstOracao(){
        switch controlOracao.currentPage {
        case 0:
            lbOracoes.adjustsFontSizeToFitWidth = true
            Creio()
            controlOracao.alpha = 1
            backHome.alpha = 0
            controlOracao.currentPage = controlOracao.currentPage + 1
        case 1:
            PaiNosso()
            controlOracao.alpha = 1
            backHome.alpha = 0
        ...
        case 5:
            ...
            backHome.alpha = 0
            controlOracao.currentPage = controlOracao.currentPage + 1
            controlOracao.alpha = 0
            controlOracaoTerco.alpha = 1
            controlOracaoFull.alpha = 1
            backHome.alpha = 0
            controlOracao.currentPage = controlOracao.currentPage + 1
        case 6:
            OracaoTerco()
    ...
    func OracaoTerco(){
        switch controlOracaoTerco.currentPage {
        case 0...4:
            avancoTerco()
    ...
    // - Retrocesso da primeira parte do terço...
    func backFirstOracao() {
//        if controlOracao.currentPage <= 7 {
                controlOracaoTerco.alpha = 0
                controlOracaoFull.alpha = 0
                controlOracao.alpha = 1
                switch controlOracao.currentPage {
                case 6:
                    Gloria()
                    controlOracao.currentPage -= 1
                case 5:
                    AveMaria()
                    controlOracao.currentPage -= 1
                case 4:
...
//        }
    ...
    func returnTerco(){
        switch controlOracaoFull.currentPage{
        case 13:
            PaiNosso()
            print("Correto!!!")
            controlOracaoFull.currentPage -= 1
    ...
    func avancoTerco(){
        if (controlOracaoTerco.currentPage == 4) && (controlOracaoFull.currentPage == 11){ // IF Trecho pra parar o terço ao final e encerrar o terço
            controlOracaoFull.alpha = 0
            controlOracaoTerco.alpha = 0
            setaNext.alpha = 0
            returnInicio.alpha = 1
           alertaAgradecimento()
        }else{
            ...
            case 12:
                Gloria()
                controlOracaoFull.currentPage += 1
                controlOracaoTerco.currentPage += 1
            case 13:
                oMeuJesus()
                controlOracaoFull.currentPage = 0
            default:
                print()
    ...
    // --------- Fim acoes
        //Saidas
    @IBOutlet weak var lbAmem: UILabel!
    @IBOutlet weak var returnInicio: UIButton!
    @IBOutlet weak var backHome: UIButton!
    @IBOutlet weak var lbOracoes: UILabel!
    @IBOutlet weak var tituloOracao: UILabel!
    @IBOutlet weak var Btnoferecimento: UIButton!
    @IBOutlet weak var setaNext: UIButton!
    @IBOutlet weak var setaBack: UIButton!
    @IBOutlet weak var controlOracao: UIPageControl!
    @IBOutlet weak var controlOracaoFull: UIPageControl!
    @IBOutlet weak var controlOracaoTerco: UIPageControl!
    @IBOutlet weak var lblMisterios: UILabel!
    @IBOutlet weak var imgGozosos: UIImageView!
    var imgMGozoso:Int = 0
    ...
    @IBAction func oferecimento(_ sender: Any) {
        tituloOracao.alpha = 1
        OferecimentoGozosos()
        Btnoferecimento.isHidden = true
        setaBack.alpha = 1
        setaNext.alpha = 1
    }
    override func viewDidLoad() {
        ...
        switch imgMGozoso {
        case 1:
            imgGozosos.image = UIImage(named: "gozosos.jpg")
            lblMisterios.text = "Mistérios Gozosos"
        case 2:
            imgGozosos.image = UIImage(named: "doloroso.jpg")
            lblMisterios.adjustsFontSizeToFitWidth = true
            lblMisterios.text = "Mistérios Dolorosos"
        case 3:
            imgGozosos.image = UIImage(named: "glorioso.jpg")
            lblMisterios.adjustsFontSizeToFitWidth = true
            lblMisterios.text = "Mistérios Gloriosos"
        case 4:
            imgGozosos.image = UIImage(named: "luminoso.jpg")
            lblMisterios.adjustsFontSizeToFitWidth = true
            lblMisterios.text = "Mistérios Luminosos"
        default:
            print()
        }
    }
